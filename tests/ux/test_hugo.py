...
DEFAULT_TIMEOUT = 15
SITENAME = "My simple hugo ananke website"
...
class TestHugo:
    ...
    def test_first_post(self, url):
        ...
        page_title = "The git workflow | "+get_default_title()

        second_post = self.get_button_by_link_name("The git workflow")
        second_post.click()
    ...
    def test_second_post(self, url):
        ...
        page_url = get_default_url(url)+"posts/second_post/"
        page_title = "Bogus content | "+get_default_title()

        second_post = self.get_button_by_link_name("Bogus content")
        second_post.click()
